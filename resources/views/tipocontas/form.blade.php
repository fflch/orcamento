<div class="form-row">
  <div class="form-group col-md-7">
    ...
    $tipoconta->descricao ?? old('descricao', ) }}" placeholder="[ Ex: Orçamento ]" maxlength="150" tabindex="1">
  </div>
  <div class="form-group col-md-3">
    ...
    <input type="checkbox" id="cpfo" name="cpfo" value="1" tabindex="2"
      @if (old('cpfo') or isset($tipoconta->id) and ($tipoconta->cpfo === 1))
        checked
      @endif >
    </label>
  </div>
  <div class="form-group col-md-2">
    ...
    <input type="checkbox" id="relatoriobalancete" name="relatoriobalancete" value="1" tabindex="3"
      @if (old('relatoriobalancete') || isset($tipoconta->id) and ($tipoconta->relatoriobalancete === 1))
        checked
      @endif >
    </label>
  </div>
