...
<div class="form-row">
        ...
        <div class="form-group col-md-7"><b>Descrição do Item:</b> {{ $dotorcamentaria->descricaoitem }}</div>
        <div class="form-group col-md-2"><b>Receita:</b>@if ($dotorcamentaria->receita == 1) [ x ] @else [ &nbsp; ] @endif </div>
        ...
        <div class="form-group col-md-4"><b>Data/Hora da Criação:</b> {{ date_format($dotorcamentaria->created_at, 'd/m/Y H:i:s') ?? '' }}</div>
        <div class="form-group col-md-4"><b>Data/Hora da Última Modificação:</b> {{ date_format($dotorcamentaria->updated_at, 'd/m/Y H:i:s') ?? '' }}</div>
    </div>
    </div>
@can('Administrador')
<br>
