...
<label>
<p><a href="{{ route('contausuarios.create') }}" class="btn btn-success">
    ...
    <table class="table table-striped" border="0">
        <thead>
            <tr align="center">
                ...
                <th width="30%" align="left">Usuário</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center">
                  <a class="btn btn-warning" href="/contausuarios/{{$contausuario->id}}/edit">Editar</a>
                </td>
                <td align="center">
