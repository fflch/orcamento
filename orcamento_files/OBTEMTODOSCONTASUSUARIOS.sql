CREATE PROCEDURE OBTEMTODOSCONTASUSUARIOS(
...
BEGIN
  ...
  C.DHMODIFICACAO, U.LOGIN, U.DESCRICAO, CT.DESCRICAO, TC.CODIGO, TC.DESCRICAO
  ...
  WHERE C.CODIGOUSUARIO = :PCODIGOUSUARIO
  ORDER BY TC.DESCRICAO, CT.DESCRICAO
  INTO :RCODIGO, :RCODIGOCONTA, :RCODIGOUSUARIO, :RUSUARIO, :RDHMODIFICACAO,
  :RLOGINUSUARIO, :RDESCRICAOUSUARIO, :RDESCRICAOCONTA, :RCODIGOTIPOCONTA,
  :RDESCRICAOTIPOCONTA
  DO
  SUSPEND;
END
